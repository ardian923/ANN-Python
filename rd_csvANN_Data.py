# modified from : http://stackoverflow.com/questions/24913212/in-python-read-in-csv-file-with-columns-of-data-and-assign-variables-according
...
def read_csv(filename):
    ...
    with open(filename) as f:
        ...
        data=np.loadtxt(filename,skiprows=3,delimiter=",")  #load all ANN data in file
        print 'All Data  : ', data
